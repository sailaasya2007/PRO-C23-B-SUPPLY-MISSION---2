...
function setup() {
	...
	locationSprite2=createSprite(310, 630, 20,80);
	locationSprite2.shapeColor=("orange");

	locationSprite3=createSprite(380, 650, 160,30);
	locationSprite3.shapeColor=("orange");
